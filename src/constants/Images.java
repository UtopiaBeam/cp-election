...
public class Images {
	...
	public static final Image prawitL = new Image(ClassLoader.getSystemResource("character/prawitL.png").toString());
	public static final Image prawitR = new Image(ClassLoader.getSystemResource("character/prawitR.png").toString());
